...
void Demo::DrawColoredCube()
{
	...
	for (int i = 0; i < 5; i++) {
		...
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(-2, 1 + i * 0.25, 0));
		model2 = glm::scale(model2, glm::vec3(1.5 - i * 0.25, 0.2, 1.5 - i * 0.25));
	...
	for(int x = 0; x < 3; x++) {
		if(x == 0) {
			...
			for (int i = 0; i < 2; i++) {
				...
				glm::mat4 model2;
				model2 = glm::translate(model2, glm::vec3(-1 + (i * 2), 0, 0));
				model2 = glm::scale(model2, glm::vec3(0.2, 2, 0.2));
			...
			for (int i = 0; i < 2; i++) {
				...
				glm::mat4 model2;
				model2 = glm::translate(model2, glm::vec3(-1 + (i * 2), 0, -2));
				model2 = glm::scale(model2, glm::vec3(0.2, 2, 0.2));
			...
			glm::mat4 model2;
			model2 = glm::translate(model2, glm::vec3(0, 1.2, 0));
			model2 = glm::scale(model2, glm::vec3(1.5, .2, 1.5));
